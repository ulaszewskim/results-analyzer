...
def add_question_image(question_images, question_charts):
    ...
    for question_image in question_images:
        crop_empty_space(question_image, os.path.join('results_temp', os.path.basename(question_image)))
        question_image = os.path.join('results_temp', os.path.basename(question_image))
        resize_width(question_image, question_image, 1000, 800)
